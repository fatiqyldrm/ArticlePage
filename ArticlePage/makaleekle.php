...
@$baglanti = new mysqli('localhost', 'root', '', 'vt_blog'); // Veritabanı bağlantımızı yapıyoruz.
...
if (isset($_GET["kaydet"])) { // Sayfada GET$_GET[""] olup olmadığını kontrol ediyoruz.
    ...
    $lisansno = $_GET["makalead"]; 
    $sirketkodu = $_GET["makaleicerik"];
    $sirketadi = $_GET["makaleyazar"];
...
<body>
    <div class="container p-5">
        <div class="card p-5">
            <form action="http://localhost:8080/yonetimpaneli/include/sekle.php" method="GET">
                <div>
                    <label>
                    <h2>Şirket Ekleme</h2> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a type="button" class="btn btn-outline-primary"
                            href="http://localhost:8080/yonetimpaneli/index.php?sayfa=sirketbilgileri">Şirket Bilgileri Tablosu</a>
                            <a type="button" class="btn btn-outline-primary"
                            href="http://localhost:8080/yonetimpaneli/">Anasayfa</a>
